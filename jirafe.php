...
// Urls configuration
define('JIRAFE_API_URL', (JIRAFE_DEBUG) ? 'http://api.jirafe.local/v1' : 'https://api.jirafe.com/v1');
define('JIRAFE_API_PORT', 80);
define('JIRAFE_TRACKER_URL', (JIRAFE_DEBUG) ? 'http://test-data.jirafe.com' : 'http://data.jirafe.com');
define('JIRAFE_ASSETS_URL_PREFIX', 'http://en.jirafe.local/dashboard'); // without trailing slash
